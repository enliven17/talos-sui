...
async function main() {
  ...
  const [talos] = await db
    ...
    .values({
      ...
      status: "Active",
      mitosCoinType: "0xcv01::mitos::CVOC",
      pulsePrice: "1.80",
      totalSupply: 600000,
      creatorShare: 0,
      investorShare: 0,
      ...
      gtmBudget: "180",
      creatorAddress: "0xcv01a11ce0000000000000000000000000000000000000000000000ab",
      onChainId: 108,
      agentName: "community-voice",
      agentWalletId: "0xcv01a6e6700000000000000000000000000000000000000000000ccff",
      agentWalletAddress: "0xcv01a6e6700000000000000000000000000000000000000000000ccff",
      agentOnline: true,
    })
    .returning();
  ...
  await db.insert(tlsPatrons).values([
    { talosId: talos.id, suiAddress: "0xcv01a11ce0000000000000000000000000000000000000000000000ab", role: "Creator", pulseAmount: 240000, share: "0" },
    { talosId: talos.id, suiAddress: "0xcv02609e6306000000000000000000000000000000000000000000d111", role: "Governor", pulseAmount: 120000, share: "0" },
    { talosId: talos.id, suiAddress: "0xcv030e9e57d6000000000000000000000000000000000000000000e222", role: "Investor", pulseAmount: 120000, share: "0" },
    { talosId: talos.id, suiAddress: "0xcv04c0107216000000000000000000000000000000000000000000f333", role: "Contributor", pulseAmount: 60000, share: "0" },
    { talosId: talos.id, suiAddress: "0xcv05ad7150700000000000000000000000000000000000000000a4444", role: "Advisor", pulseAmount: 60000, share: "0" },
  ]);
  ...
  await db.insert(tlsCommerceServices).values({
    ...
    price: "0.012",
    suiAddress: "0xcv01a11ce0000000000000000000000000000000000000000000000ab",
    chains: ["sui"],
