...
async function main() {
  ...
  const talosData = [
    // ── SALES Category ──
    {
      ...
      status: "Active",
      mitosCoinType: "0x73734816::mitos::SGNL",
      tokenSymbol: "SGNL",
      pulsePrice: "2.50",
      totalSupply: 500000,
      creatorShare: 0,
    ...
    },
    {
      ...
      status: "Active",
      mitosCoinType: "0x73734817::mitos::ENRCH",
      tokenSymbol: "ENRCH",
      pulsePrice: "0.85",
      totalSupply: 2000000,
      creatorShare: 0,
    ...
    },
    {
      ...
      status: "Active",
      mitosCoinType: "0x73734818::mitos::LEADS",
      tokenSymbol: "LEADS",
      pulsePrice: "5.00",
      totalSupply: 300000,
      creatorShare: 0,
    ...
    // ── ANALYTICS Category ──
    {
      ...
      status: "Active",
      mitosCoinType: "0x73734819::mitos::SCOUT",
      tokenSymbol: "SCOUT",
      pulsePrice: "1.20",
      totalSupply: 1000000,
      creatorShare: 0,
    ...
    },
    {
      ...
      status: "Active",
      mitosCoinType: "0x7373481a::mitos::TRND",
      tokenSymbol: "TRND",
      pulsePrice: "0.35",
      totalSupply: 5000000,
      creatorShare: 0,
    ...
    },
    {
      ...
      status: "Active",
      mitosCoinType: "0x7373481b::mitos::AUDNC",
      tokenSymbol: "AUDNC",
      pulsePrice: "8.00",
      totalSupply: 150000,
      creatorShare: 0,
    ...
    // ── DEVELOPMENT Category ──
    {
      ...
      status: "Active",
      mitosCoinType: "0x7373481c::mitos::NEXUS",
      tokenSymbol: "NEXUS",
      pulsePrice: "3.00",
      totalSupply: 800000,
      creatorShare: 0,
    ...
    // ── MARKETING Category ──
    {
      ...
      status: "Active",
      mitosCoinType: "0x7373481d::mitos::VOICE",
      tokenSymbol: "VOICE",
      pulsePrice: "1.80",
      totalSupply: 600000,
      creatorShare: 0,
  ...
  for (const c of talosData) {
    const [talos] = await db
      ...
      .values({
        ...
        status: c.status,
        mitosCoinType: (c as unknown as Record<string, string | null | undefined>).mitosCoinType ?? null,
        tokenSymbol: (c as unknown as Record<string, string | null | undefined>).tokenSymbol ?? null,
        ...
        toneVoice: (c as unknown as Record<string, string | null | undefined>).toneVoice ?? null,
        agentWalletId: (c as unknown as Record<string, string | null | undefined>).agentWalletId ?? null,
        agentWalletAddress: (c as unknown as Record<string, string | null | undefined>).agentWalletAddress ?? null,
    ...
    const svc = c as unknown as { serviceName?: string; serviceDesc?: string; servicePrice?: string };
    if (svc.serviceName && svc.servicePrice) {
      await db.insert(tlsCommerceServices).values({
        talosId: talos.id,
        serviceName: svc.serviceName,
        description: svc.serviceDesc ?? null,
        price: svc.servicePrice,
        suiAddress: c.creatorAddress,
        chains: ["sui"],
