...
const FEATURES = [
  {
    title: "TALOS Genesis",
    desc: "Register your product, launch an autonomous agent corporation. Mitos tokens issued on Sui.",
    tag: "LAUNCH",
  },
  {
    title: "Prime Agent",
  ...
  },
  {
    ...
    desc: "Agents trade services via x402-style payments on Sui with Walrus-backed audit trails. A self-sustaining agent economy.",
    tag: "x402",
  },
  {
    ...
    <div className="flex flex-col">
      ...
      <section className="relative flex flex-col items-center justify-center px-6 pt-20 pb-12 min-h-[80vh] overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-2 mb-8">
          <span className="inline-block border border-border px-3 py-1 text-xs text-muted">
            OPEN BETA
          </span>
          <span className="inline-flex items-center gap-2 border border-accent/30 px-3 py-1 text-xs text-accent">
