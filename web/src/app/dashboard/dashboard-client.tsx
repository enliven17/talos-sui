...
import { suiscanAddressUrl, suiscanTxUrl } from "@/lib/explorer";
...
export function DashboardClient() {
  return (
    <WalletGate
      ...
      description="Your patron dashboard shows your portfolio, pending approvals, and agent activity. Connect your Sui wallet to view your TALOS holdings."
    >
      <DashboardLoader />
    </WalletGate>
  );
                ...
                <div key={c.id} className="bg-surface border border-border p-5">
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex justify-between gap-2">
                      <span className="text-muted shrink-0">Coin Type</span>
                      <span className="text-foreground font-mono truncate text-right">
                        {c.mitosCoinType
                          ? `${c.mitosCoinType.slice(0, 18)}…${c.mitosCoinType.slice(-12)}`
                          : "—"}
                      </span>
                    </div>
                    ...
                    {c.agentWalletAddress && (
                      <a
                        href={suiscanAddressUrl(c.agentWalletAddress)}
                        target="_blank"
                        rel="noopener noreferrer"
