...
10. **Distribute**: If revenue was earned → distribute dividends via transfer_sui
...
- Below threshold: execute autonomously (use transfer_sui or purchase_service directly)
...
- Internal economy (dividends): use transfer_sui
